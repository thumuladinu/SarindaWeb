...
var o = (t2, e2, n2, o2, l2, r3, i, s) => r3 < t2 && i > e2 || r3 > t2 && i < e2 ? 0 : r3 <= t2 && s <= n2 || i >= e2 && s >= n2 ? r3 - t2 - o2 : i > e2 && s < n2 || r3 < t2 && s > n2 ? i - e2 + l2 : 0;
var l = (t2) => {
...
var r2 = (e2, r3) => {
  ...
  for (let t2 = 0; t2 < w.length; t2++) {
    const e3 = w[t2], { height: l2, width: r4, top: i2, right: s2, bottom: d2, left: h2 } = e3.getBoundingClientRect();
    ...
    let B2 = 0, F2 = 0;
    const V2 = "offsetWidth" in e3 ? e3.offsetWidth - e3.clientWidth - g2 - W2 : 0, S = "offsetHeight" in e3 ? e3.offsetHeight - e3.clientHeight - p2 - T2 : 0, X = "offsetWidth" in e3 ? 0 === e3.offsetWidth ? 0 : r4 / e3.offsetWidth : 0, Y = "offsetHeight" in e3 ? 0 === e3.offsetHeight ? 0 : l2 / e3.offsetHeight : 0;
    if (m === e3) B2 = "start" === f ? k : "end" === f ? k - H : "nearest" === f ? o(M, M + H, H, p2, T2, M + k, M + k + v, v) : k - H / 2, F2 = "start" === u ? D : "center" === u ? D - b / 2 : "end" === u ? D - b : o(y, y + b, b, g2, W2, y + D, y + D + E, E), B2 = Math.max(0, B2 + M), F2 = Math.max(0, F2 + y);
      ...
      B2 = "start" === f ? k - i2 - p2 : "end" === f ? k - d2 + T2 + S : "nearest" === f ? o(i2, d2, l2, p2, T2 + S, k, k + v, v) : k - (i2 + l2 / 2) + S / 2, F2 = "start" === u ? D - h2 - g2 : "center" === u ? D - (h2 + r4 / 2) + V2 / 2 : "end" === u ? D - s2 + W2 + V2 : o(h2, s2, r4, g2, W2 + V2, D, D + E, E);
      const { scrollLeft: t3, scrollTop: n2 } = e3;
      B2 = 0 === Y ? 0 : Math.max(0, Math.min(n2 + B2 / Y, e3.scrollHeight - l2 / Y + S)), F2 = 0 === X ? 0 : Math.max(0, Math.min(t3 + F2 / X, e3.scrollWidth - r4 / X + V2)), k += n2 - B2, D += t3 - F2;
    }
...
//# sourceMappingURL=chunk-ZIXF4PID.js.map
