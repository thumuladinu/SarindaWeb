...
/**
 * Official Standard Rice Bag Label Component
 * High-contrast layout designed for thermal sticker rolls & A4 label sheets.
 */
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-12 border-b-2 border-black py-2 gap-1 items-center">
                ...
                {/* Right Internal QR Scanner Code */}
