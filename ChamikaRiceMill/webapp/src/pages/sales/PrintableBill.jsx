    ...
    if (isRetailSale) {
        return (
            <>
                <style>{`
                    @media print {
                        ...
                        #bp  {
                            ...
                            width: 215mm !important; max-width: 215mm !important;
                            height: 280mm !important; max-height: 280mm !important;
                ...
                <div id="pw">
                    {/* Screen toolbar */}
                    <div id="pab" style={{ display:'flex', justifyContent:'flex-end', maxWidth:'215mm', margin:'0 auto 12px' }}>
                        <Button type="primary" icon={<PrinterOutlined />} size="large" onClick={() => window.print()}>Print Receipt</Button>
                    </div>

                    {/* 21.5cm x 28cm PAGE */}
                    <div id="bp" style={{
                        fontFamily: F, fontSize: '10.5px', lineHeight: '1.35', color: '#000', background: '#fff',
                        width: '215mm', height: '280mm', boxSizing: 'border-box', padding: '5mm 8mm',
                        margin: '0 auto', display: 'flex', flexDirection: 'column', overflow: 'hidden',
                    }}>
                        {/* Header */}
                        <div>
                            <hr style={dhr} />
                            <div style={{ textAlign:'center', fontWeight:'bold', fontSize:'16px', letterSpacing:'2px', margin:'2px 0 1px' }}>
                                CHAMIKA RICE MILLS
                            </div>
                            <div style={{ textAlign:'center', fontSize:'10.5px' }}>Sooriyawewa</div>
                            <div style={{ textAlign:'center', fontSize:'9.5px', color:'#333' }}>
                                Tel: {MILL_PHONE}
                            </div>
                            <div style={{ textAlign:'center', fontWeight:'bold', fontSize:'12px', margin:'3px 0 1px' }}>
                        ...
                        <div style={{ display:'flex', justifyContent:'space-between', margin:'5px 0' }}>
                            <div>
                                ...
                                <div style={{ marginBottom:'3px' }}><strong>CUSTOMER</strong>&nbsp;&nbsp;&nbsp;: <strong>{(bill.CUSTOMER_NAME && bill.CUSTOMER_NAME !== 'Walk-in Customer' && bill.CUSTOMER_NAME !== 'Walk-in') ? bill.CUSTOMER_NAME : '..................................................................'}</strong></div>
                        ...
                        <div style={{ textAlign:'center', fontSize:'10.5px', fontWeight:'bold', margin:'3px 0' }}>
                            THANK YOU FOR YOUR BUSINESS!
                        </div>
                        <div style={{ textAlign:'center', fontSize:'8.5px', color:'#555', marginTop:'2px' }}>
    ...
    return (
        <>
            ...
            <div id="pw">
                ...
                {/* ══════════════ 21.5cm x 28cm PAGE ══════════════ */}
                <div id="bp" style={{
                    fontFamily: F, fontSize: '10px', lineHeight: '1.35', color: '#000', background: '#fff',
                    width: '215mm', height: '280mm', boxSizing: 'border-box', padding: '5mm 8mm',
                    margin: '0 auto', display: 'flex', flexDirection: 'column', overflow: 'hidden',
                }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '2px 0' }}>
                            <div style={{ width: '60px', textAlign: 'left', display: 'flex', alignItems: 'center' }}>
                                <img src="/bill_logo.png" style={{ maxHeight: '44px', maxWidth: '55px', objectFit: 'contain' }} alt="Logo" onError={e => { e.target.style.display = 'none'; }} />
                            </div>
                            <div style={{ flex: 1, textAlign: 'center' }}>
                                <div style={{ fontWeight: 'bold', fontSize: '16px', letterSpacing: '3px', margin: '1px 0' }}>
                                    {localStorage.getItem('mill_name') || 'CHAMIKA RICE MILLS'}
                                </div>
                                <div style={{ fontSize: '10.5px' }}>{localStorage.getItem('mill_address') || 'Sooriyawewa'}</div>
                                <div style={{ fontSize: '9.5px', color: '#333' }}>
                                    Tel: {localStorage.getItem('mill_phone') || MILL_PHONE}
                                </div>
                            </div>
                    ...
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', margin:'3px 0' }}>
                        ...
                        <div>
                            ...
                            <div><strong>VEHICLE / LORRY</strong> : <strong>{bill.VEHICLE_NO || bill.LORRY_NO || '....................'}</strong></div>
                        </div>
                        {/* Right */}
                        <div style={{ textAlign:'right' }}>
                            ...
                            <div style={{ fontSize:'8px', color:'#555', marginBottom:'1px' }}>
                                Printed: {fmtPrint(printedAt)}
                            </div>
                            <div style={{ marginBottom: '2px' }}><strong>DATE</strong> : <strong>{fmtDate(bill.DATE)}</strong></div>
                            <div><strong>DRIVER</strong> : <strong>{bill.DRIVER_NAME || '....................'}</strong></div>
                        </div>
                    </div>
                    ...
                    <div style={{ margin:'3px 0' }}>
                        <div style={{ marginBottom:'2px' }}>
                            ...
                            <strong>{(bill.CUSTOMER_NAME && bill.CUSTOMER_NAME !== 'Walk-in Customer' && bill.CUSTOMER_NAME !== 'Walk-in') ? bill.CUSTOMER_NAME : '..................................................................'}</strong>
                        </div>
                        <div style={{ marginBottom:'2px' }}>
                    ...
                    <table style={{ width:'100%', borderCollapse:'collapse', margin:'1.5px 0' }}>
                        <tbody>
                            {[
                                ...
                                <tr key={label}>
                                    <td style={{ padding:'2px 5px', textAlign:'right', fontWeight: big?'bold':'normal', fontSize: big?'11.5px':'10px' }}>
                                        {label} :
                                    </td>
                                    <td style={{
                                        padding:'2px 6px', textAlign:'right', width:'28%',
                                        fontWeight: bold||big?'bold':'normal', fontSize: big?'11.5px':'10px',
                    ...
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', margin:'1px 0 2px', fontSize:'10.5px' }}>
                    ...
                    <div style={{ marginTop: '2px' }}>
                        <div>
                            <div style={{ fontWeight:'bold', fontSize:'13.5px', margin:'1px 0 2px', fontFamily: "'Noto Sans Sinhala', 'Iskoola Pota', 'Abhaya Libre', sans-serif" }}>
                        ...
                        <div style={{ marginTop: '4px' }}>
                            ...
                            <div style={{ display:'flex', justifyContent:'space-between', marginTop:'2px' }}>
                                ...
                                <div style={{ textAlign:'right' }}>
                                    ...
                                    <div style={{ border: DBL, width:'80mm', height:'18mm', boxSizing:'border-box', marginTop:'2px' }}></div>
                                    <div style={{ fontSize:'8px', marginTop:'2px' }}>(භාණ්ඩ ලැබුණු බව තහවුරු කිරීමට)</div>
                                </div>
                            </div>
                        </div>
                    </div>
