...
router.post('/api/getAllCustomers', async (req, res) => {
    ...
    try {
        ...
        const queryResult = await pool.query('SELECT * FROM store_customers WHERE IS_ACTIVE=1');
...
router.post('/api/getDueCustomers', async (req, res) => {
    //console.log('Get all customers request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerDetails', async (req, res) => {
    ...
    try {
        ...
        // Query to fetch all active customers
        const queryResult = await pool.query('SELECT * FROM store_customers WHERE IS_ACTIVE=1 AND CUSTOMER_ID = ?', [req.body.CUSTOMER_ID]);
...
router.post('/api/addCustomer', async (req, res) => {
    ...
    try {
        ...
        const insertResult = await pool.query('INSERT INTO store_customers SET ?', req.body);
...
router.post('/api/updateCustomer', async (req, res) => {
    ...
    try {
        ...
        const updateResult = await pool.query('UPDATE store_customers SET ? WHERE CUSTOMER_ID = ?', [
            updatedCustomerData,
            CUSTOMER_ID,
        ]);
...
router.post('/api/deactivateCustomer', async (req, res) => {
    ...
    try {
        ...
        const updateResult = await pool.query('UPDATE store_customers SET IS_ACTIVE = 0 WHERE CUSTOMER_ID = ?', [
            CUSTOMER_ID,
        ]);
...
router.post('/api/getCustomerTransactions', async (req, res) => {
...
router.post('/api/getCustomerBuyerTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerSellerTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerPartnerTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerSalesPersonTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerPreformerTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerCPTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerElectricTransactions', async (req, res) => {
    // console.log('Get all Customer Transaction request received:');
    try {
        // Ensure the MySQL connection pool is defined
        if (!pool) {
...
router.post('/api/getCustomerHeatTTransactions', async (req, res) => {
